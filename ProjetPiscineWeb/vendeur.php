...
if($db_found)
{
  ...
  $sql3bis = "SELECT photos_item FROM `item` WHERE id_item=2";
}
else 
{
	...
	<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
		...
		<div class="collapse navbar-collapse" id="main-navigation">
			...
			<ul class="navbar-nav">             
				...
				<li class="nav-item"><a class="nav-link" href="http://localhost/ProjetPiscineWeb/GerermesStocks.php">Mes Stocks</a></li>
...
<div class="container">   
	  ...
	  $id_mventes1=1;
	  $request="SELECT photos_item, nom_item, id_item, prix_item FROM item where id_mesventes= '".$id_mventes1."'";
	  if($db_found)
	  {
