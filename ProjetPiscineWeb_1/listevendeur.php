  ...
  if (isset($_POST['envoi'])) 
            {
              ...
              if($db_found)
              {
                $sql = "INSERT INTO `vendeur`(`email_vendeur`, `nom_vendeur`, `photo_vendeur`, `photo_fond`, `email`, `email_admin`, `id_ventes`) VALUES ('$email_vendeur','$nom_vendeur','$photo_profil','$photo_fond','','',DEFAULT)";
