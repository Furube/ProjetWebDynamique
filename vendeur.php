	...
	<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
		...
		<div class="collapse navbar-collapse" id="main-navigation">
			...
			<ul class="navbar-nav">             
				...
				<li class="nav-item"><a class="nav-link" href="http://localhost/ProjetPiscineWeb/gerer_mes_stocks.php">Mes Stocks</a></li>
...
<div class="container">   
	...
	foreach($id_items as $value)
	{
		...
		$mes_items="SELECT photos_item, nom_item, id_item, prix_item FROM item WHERE id_item='".$value."'";
